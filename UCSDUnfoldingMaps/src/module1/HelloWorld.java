...
public class HelloWorld extends PApplet
{
	...
	/** The map you will use to display your home town DaeJeon South Korea */ 
	UnfoldingMap map2;

	public void setup() {
		size(1000, 1000, P2D);  // Set up the Applet window to be 800x600
		...
		AbstractMapProvider provider1 = new Microsoft.AerialProvider();
		...
		map2 = new UnfoldingMap(this, 550, 50, 350, 500, provider2);
		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
		// this is the location for the ucsd
		// want to use this to get the location of my home town
	    map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
	    map2.zoomAndPanTo(zoomLevel2, new Location(36.35f, 127.38f));
